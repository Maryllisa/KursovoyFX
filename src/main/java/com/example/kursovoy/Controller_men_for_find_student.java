...
public class Controller_men_for_find_student {
    ...
    void initialize() {
        ...
        name.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                output.writeInt(9);
                root = FXMLLoader.load(getClass().getResource("/find/find_name.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        surname.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_surname.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        patronymic.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_patronymic.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        age.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_age.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        groupa.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_group.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        curs.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_cours.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        spec.setOnAction(actionEvent -> {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_spec.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        facult.setOnAction(actionEvent ->
        {
            ...
            try {
                ...
                root = FXMLLoader.load(getClass().getResource("/find/find_facult.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
