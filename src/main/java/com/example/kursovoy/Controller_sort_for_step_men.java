...
public class Controller_sort_for_step_men {
    ...
    void initialize() {
        ...
        amount.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_amount.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        coef.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_coeff.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        up_coef.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_up_inputCoeff.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        down_coef.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_down_inputCoeff.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        up_amount.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_up_inpuAmount.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
        ...
        down_amount.setOnAction(actionEvent ->
        {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/filters/sort_down_inputAmount.fxml"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            stage = new Stage();
