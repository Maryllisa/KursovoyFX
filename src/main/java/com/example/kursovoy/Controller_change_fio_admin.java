...
public class Controller_change_fio_admin extends Cheaker {
        ...
        change.setOnAction(actionEvent ->
        {
            try {
                if (proverka()) {
                    ...
                    output.writeInt(surname.getText().length());
                    for (int i = 0; i < surname.getText().length(); i++) {
                        output.writeChar(surname.getText().charAt(i));
                    }
                    output.writeInt(name.getText().length());
                    for (int i = 0; i < name.getText().length(); i++) {
                        output.writeChar(name.getText().charAt(i));
                    }
                    output.writeInt(patronymic.getText().length());
                    for (int i = 0; i < patronymic.getText().length(); i++) {
                        output.writeChar(patronymic.getText().charAt(i));
                    }
